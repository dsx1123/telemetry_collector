...
def set_id_target():
  global target_lab
  print("The lab in the .env file is: " + os.getenv('LAB_ID'))
  if os.getenv('LAB_ID') == "lab_2106":
    target_lab = lab_2106
    print("processing lab 2106")
  if os.getenv('LAB_ID') == "lab_1021":
    target_lab = lab_1021
    print("processing lab 2021")

# load_dotenv()
# print(os.getenv('LAB_ID'))
# target_lab = os.getenv('LAB_ID')
# print(target_lab)
...
SharedSvsPORT = 2122
# print (SharedSvsPORT)
# print ("type(SharedSvsPORT)")
# print (type(SharedSvsPORT))

# systems_MASTER = [
#     {'name': 'system_name',
#      'term_server_ip': '3.3.3.3',
#      'telnet_port': 0000,
#      'sw': 'iosxe, iosxr, or nxos',
#      'mgmt_vrf': 'Mgmt_vrf',
#      'mgmt_ip': '1.1.1.1',
#      'mgmt_mask': '255.255.255.NNN',
#      'mgmt_dgw': '1.1.1.1', 
#      'mgmt_intf_name': "Gi0/0/0",
#      'username': 'admin',
#      'password': 'cisco!123',
#      'problems': ['aaa_authorization', 'no_mgmt_ip']
#     },
#     {
#     # additional systems      
#     }
...
lab_2106 = [
    {'name': 'MXC.TAC.L.11-8200-01',
     'term_server_ip': '10.88.241.69',
     'telnet_port': 2122,
     'sw': 'iosxe',
     'mgmt_vrf': 'Mgmt_vrf',
     'mgmt_ip': '10.31.122.16',
     'mgmt_mask': '255.255.255.224',
     'mgmt_dgw': '10.31.122.1', 
     'mgmt_intf_name': "Gi0/0/0",
     'username': 'admin',
     'password': 'cisco!123',
     'problems': ['aaa_authorization', 'no_mgmt_ip']
    },
    {'name': 'MXC.TAC.L.11-8200-02',
     'term_server_ip': '10.88.241.69',
     'telnet_port': 2123,
     'sw': 'iosxe',
     'mgmt_vrf': 'Mgmt_vrf',
     'mgmt_ip': '10.31.122.15',
     'mgmt_mask': '255.255.255.224',
     'mgmt_dgw': '10.31.122.1', 
     'mgmt_intf_name': "Gi0/0/0",
     'username': 'admin',
