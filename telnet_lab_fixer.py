...
target_lab = "/vagrant/etc/playbook/" + os.getenv('LAB_ID')
print("The target lab is:  " + target_lab)
with open(target_lab, 'r') as f:
    ...
    for system in target_lab:
        ...
        try:
            ...
            if b'rommon' in response:
                ...
                print("  ERROR:  SWITCH IS IN ROMMON MODE!! ")
                print("****************************************************************************")
            elif b'Username:' in response:
                print("****************************************************************************")
                print("  Telnet ==> Username ")
                print("****************************************************************************")
                print(b'Switch has returned Username response ' + response)
                ...
                if b'Password:' in response:
                    print("****************************************************************************")
                    print("  Telnet ==> Username ==> Password")
                    print("****************************************************************************")
                    ...
                    if b'>' in response:
                        print("****************************************************************************")
                        print("  Telnet ==> Username ==> Password ==> host> ")
                        print("****************************************************************************")
                        ...
                        if b'Password:' in response:
                            ...
                            if b'#' in response:
                                ...
                                print("****************************************************************************")
                                print(" Looks like enable secret is different than logon password ")
                                print("****************************************************************************")
                        elif b'#' in response:
                            print("****************************************************************************")
                            print(" Telnet ==> Username ==> host# ")
                            print("****************************************************************************")
                            print(b'Switch appears to be in enable mode...' + response)
                            print(" Enter configuration mode ")
                            s.send(b'conf t')
                            ...
                            print("***********************************************************")
                            print(" Unexpected situation after username password was entered *")
                            print("***********************************************************")
            elif b'>' in response:
                print("****************************************************************************")
            ...
            #   remediation(problem_list, term_server_ip, telnet_port)
                ...
                response = s.recv(2048)
                print(" ######################################################### ")
                print("  Display username / passwords ")
                print(" ######################################################### ")
                print(response)
            #   print("Call remediation function")
            #   s.close()
            ...
            for problem in problem_list:
                ...
                if problem == "aaa_authorization":
                    ...
                    time.sleep(2)
                    ########################################################
                    send_string = "ip route vrf " + management_vrf + " 0.0.0.0 0.0.0.0 " + management_default_gateway
                    print(" Command sent to socket: " + send_string)
                    s.send(send_string.encode())
                    s.send(b'\r')
                    time.sleep(2)
